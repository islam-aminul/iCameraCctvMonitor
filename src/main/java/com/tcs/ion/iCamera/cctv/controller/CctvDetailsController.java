...
/**
 * CCTV Details page – sortable/filterable table of all CCTV cameras.
 */
public class CctvDetailsController implements Initializable {
    ...
    @FXML private TableColumn<CctvRow, Integer>    colId;
    ...
    @FXML private TableColumn<CctvRow, String>     colEncoding;
    @FXML private TableColumn<CctvRow, String>     colProfile;
    @FXML private TableColumn<CctvRow, String>     colFps;
    @FXML private TableColumn<CctvRow, String>     colResolution;
    ...
    private void setupTable() {
        colId.setCellValueFactory(d -> d.getValue().getId().asObject());
        ...
        colEncoding.setCellValueFactory(d -> d.getValue().getEncoding());
        colProfile.setCellValueFactory(d -> d.getValue().getProfile());
        colFps.setCellValueFactory(d -> d.getValue().getFps());
        colResolution.setCellValueFactory(d -> d.getValue().getResolution());
    ...
    public static class CctvRow {
        ...
        public CctvRow(CctvData c) {
            ...
            fps.set(c.getFps() > 0 ? String.format("%.1f", c.getFps()) : "N/A");
        ...
        public StringProperty  getEncoding() { return encoding; }
        public StringProperty  getProfile()  { return profile; }
        public StringProperty  getFps()      { return fps; }
        public StringProperty  getResolution(){ return resolution; }
